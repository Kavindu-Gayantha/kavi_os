...
;===================================================================
	...
	BITS 16
	%DEFINE KAVIOS_VER '1.0.0'	 ;OS version number
	%DEFINE KAVIOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as KAVIOS and its programs
...
option_screen:
				; If HDIOK (option 0) chosen, start app selector
	call os_draw_background1
	...
	os_init_msg2		db 'KAVI_OS_Hardware Information', 0
	os_version_msg2		db 'Version ', KAVIOS_VER, 0

	dialog_string_1		db 'Welcome to kaviOs Operating System', 0
...
os_draw_background1:
	...
	mov cx,111		; Colour: white text on brown background
